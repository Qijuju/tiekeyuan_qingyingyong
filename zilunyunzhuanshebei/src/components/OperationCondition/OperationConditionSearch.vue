    ...
    <van-row v-show="showxmgljg">
      <van-col>
        <van-picker :columns="xmgljgcolumns"
                    visible-item-count=3 v-bind:xmmc="xmgljg" show-toolbar @cancel="closeAll"
...
<script>
    ...
    export default {
      name: "operation-condition-search",
      components: {
      ...
      methods: {
        ...
        onClickRight() {
          ...
          this.$router.push({path: '/OperationCondition/OperationConditionIndex',query:query});
